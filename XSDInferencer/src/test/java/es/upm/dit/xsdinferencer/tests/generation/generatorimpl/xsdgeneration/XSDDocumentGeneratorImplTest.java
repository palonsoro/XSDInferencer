...
/**
 * Test class for {@link XSDDocumentGeneratorImpl}
 * @author Pablo Alonso Rodriguez (Center for Open Middleware)
 */
public class XSDDocumentGeneratorImplTest {
	//Fields for testing
...
//		prefixNamespaceMapping.put(NAMESPACE_URI_TESTING, new TreeSet<>(Collections.singleton("testing")));
		...
		schema1 = new Schema(prefixNamespaceMapping, elements, attributes, complexTypes, simpleTypes, new Statistics(6));
	...
	private void buildComplexTypesScenario2(){
		complexTypeScenario2TestRoot=new ComplexType("test_root", new ExtendedAutomaton(), new SimpleType("test_root"), new ArrayList<SchemaAttribute>());
		complexTypeScenario2TestRoot.setRegularExpression(emptyRegexp);
		complexTypeScenario2TestingRaiz=new ComplexType("testing_raiz", new ExtendedAutomaton(), new SimpleType("testing_raiz"), new ArrayList<SchemaAttribute>());
	...
	private void buildSchemaElementsScenario2(){
		elementScenario2TestRoot = new SchemaElement("root", NAMESPACE_URI_TEST, complexTypeScenario2TestRoot);
		elementScenario2TestRoot.setValidRoot(true);
		elementScenario2TestingRaiz = new SchemaElement("raiz", NAMESPACE_URI_TESTING, complexTypeScenario2TestingRaiz);
	...
	private void buildSchemaScenario2() {
		...
		elements.put(NAMESPACE_URI_TESTING, "testing_raiz", elementScenario2TestingRaiz);
			
	
		Table<String, String, SchemaAttribute> attributes = HashBasedTable.create(2,1);
			
		Map<String, SimpleType> simpleTypes = new HashMap<>(17);
		simpleTypes.put("test_root", complexTypeScenario2TestRoot.getTextSimpleType());
		simpleTypes.put("testing_raiz", complexTypeScenario2TestingRaiz.getTextSimpleType());
		
	
		schema2 = new Schema(prefixNamespaceMapping, elements, attributes, complexTypes, simpleTypes, new Statistics(6));
	...
	/**
	 * Test that checks the XSD generated for the main namespace from a complex scenario when only 
	 * the main namespace is known (although there are other declared namespaces)
	 */
	@Test
	public void testScenario1WholeXSDSingleNamespaceNormal() {
		...
		XSDDocumentGenerator xsdGenerator = XSDDocumentGeneratorFactory.getInstance().getXSDDocumentGeneratorInstance();
		Document xsdDocument = xsdGenerator.generateSchemaDocument(schema1, configuration1, "", "", null);
...
//		System.out.println(xsdOutputString);
		...
		String expectedOutput = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
				"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" elementFormDefault=\"qualified\"><xs:simpleType name=\"_root-_element1-_a-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /><xs:enumeration value=\"cuarenta\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element1-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"hasta luego\" /><xs:enumeration value=\"hola\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_a-SimpleType\"><xs:restriction base=\"xs:integer\"><xs:enumeration value=\"40\" /><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"adios\" /><xs:enumeration value=\"buenos dias\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:complexType name=\"_root-_element1-_c\"><xs:sequence><xs:element name=\"e\" type=\"_root-_element1-_c-_e\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element1-_b\" /><xs:complexType name=\"_root-_element1-_a\"><!--Comentario A--></xs:complexType><xs:complexType name=\"_root-_element1-_c-_e\" /><xs:complexType name=\"_root-_element2-_d\" /><xs:complexType name=\"_root-_element2-_c\"><xs:sequence><xs:element name=\"f\" type=\"_root-_element2-_c-_f\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element2\"><xs:sequence><xs:element name=\"a\" type=\"_root-_element2-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element2-_b-SimpleType\" /><xs:element name=\"c\" type=\"_root-_element2-_c\" maxOccurs=\"unbounded\" minOccurs=\"1\" /><xs:element name=\"d\" type=\"_root-_element2-_d\" /></xs:sequence><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"optional\" /><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute name=\"attr4\" type=\"xs:string\" use=\"optional\" /></xs:complexType><xs:complexType name=\"_root-_element1\"><!--Comentario 1--><!--Otro comentario 1--><xs:sequence><xs:choice><xs:element name=\"a\" type=\"_root-_element1-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element1-_b-SimpleType\" /></xs:choice><xs:element name=\"c\" type=\"_root-_element1-_c\" /></xs:sequence><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"required\" /><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute name=\"attr3\" type=\"xs:boolean\" use=\"required\" /></xs:complexType><xs:complexType name=\"_root\"><xs:sequence><xs:element name=\"element1\" type=\"_root-_element1\" /><xs:element name=\"element2\" type=\"_root-_element2\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element2-_a\" /><xs:complexType name=\"_root-_element2-_b\" /><xs:complexType name=\"_root-_element2-_c-_f\" /><xs:element name=\"root\" type=\"_root\" /></xs:schema>"+lineSeparator;
...
//		}
	...
	/**
	 * Test that checks the XSD documents generated for the main namespace from a complex scenario when 
	 * there are elements and attributes of many namespaces and the workaround is enabled.
	 */
	@Test
	public void testScenario1WholeXSDManyNamespacesWorkaround() {
		...
		when(configuration1.getSimpleTypesGlobal()).thenReturn(true);
		when(configuration1.getComplexTypesGlobal()).thenReturn(true);
		XSDDocumentGeneratorFactory xsdDocumentGeneratorFactoryInstance = XSDDocumentGeneratorFactory.getInstance();
		XSDDocumentGenerator xsdGenerator = xsdDocumentGeneratorFactoryInstance.getXSDDocumentGeneratorInstance();
		Document xsdDocumentDefaultNS = xsdGenerator.generateSchemaDocument(schema1, configuration1, "", "", xsdFileNameGenerator);
		//Schema document is partially sorted so that problems related to unordered data structures are avoided
		//this absence of order does not make any trouble with XSD but turns the verification quite complicated
		...
		format.setLineSeparator(LineSeparator.SYSTEM);
		XMLOutputter outputter = new XMLOutputter(format);
		String xsdOutputStringDefaultNS = outputter.outputString(xsdDocumentDefaultNS);
//		System.out.println(xsdOutputString);
		String lineSeparator = System.getProperty("line.separator");
		String expectedOutputDefaultNS = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
			"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" elementFormDefault=\"qualified\"><xs:import namespace=\"http://probando.net\" schemaLocation=\"schema-ns_testing.xsd\" /><xs:import namespace=\"http://prueba.net\" schemaLocation=\"schema-ns_test.xsd\" /><xs:simpleType name=\"_root-_element1-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"hasta luego\" /><xs:enumeration value=\"hola\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_a-SimpleType\"><xs:restriction base=\"xs:integer\"><xs:enumeration value=\"40\" /><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element1-_a-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /><xs:enumeration value=\"cuarenta\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"adios\" /><xs:enumeration value=\"buenos dias\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:complexType name=\"_root-_element1-_a\"><!--Comentario A--></xs:complexType><xs:complexType name=\"_root-_element1-_b\" /><xs:complexType name=\"_root-_element1-_c\"><xs:group ref=\"test:e-_root-_element1-_c-_e\" /></xs:complexType><xs:complexType name=\"_root-_element1-_c-_e\" /><xs:complexType name=\"_root-_element2-_a\" /><xs:complexType name=\"_root-_element2-_b\" /><xs:complexType name=\"_root-_element2-_c-_f\" /><xs:complexType name=\"_root-_element2-_d\" /><xs:complexType name=\"_root-_element2-_c\"><xs:sequence><xs:element name=\"f\" type=\"_root-_element2-_c-_f\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element2\"><xs:sequence><xs:element name=\"a\" type=\"_root-_element2-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element2-_b-SimpleType\" /><xs:group ref=\"test:c-_root-_element2-_c\" maxOccurs=\"unbounded\" minOccurs=\"1\" /><xs:group ref=\"testing:d-_root-_element2-_d\" /></xs:sequence><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attributeGroup ref=\"test:_root-_element2-attr2\" /><xs:attributeGroup ref=\"testing:_root-_element2-attr4\" /></xs:complexType><xs:complexType name=\"_root-_element1\"><!--Comentario 1--><!--Otro comentario 1--><xs:sequence><xs:choice><xs:element name=\"a\" type=\"_root-_element1-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element1-_b-SimpleType\" /></xs:choice><xs:group ref=\"test:c-_root-_element1-_c\" /></xs:sequence><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attributeGroup ref=\"test:_root-_element1-attr2\" /><xs:attribute name=\"attr3\" type=\"xs:boolean\" use=\"required\" /></xs:complexType><xs:complexType name=\"_root\"><xs:sequence><xs:element name=\"element1\" type=\"_root-_element1\" /><xs:element name=\"element2\" type=\"_root-_element2\" /></xs:sequence></xs:complexType><xs:element name=\"root\" type=\"_root\" /></xs:schema>"+lineSeparator;
//		for(int i=0;i<expectedOutput.length();i++){
//			if(expectedOutput.charAt(i)!=xsdOutputString.charAt(i))
//				System.err.println("Difference at index "+i+". Expected char is '"+expectedOutput.charAt(i)+"' but found is '"+xsdOutputString.charAt(i)+"'");
//		}
		...
		Document xsdDocumentTestNS = xsdGenerator.generateSchemaDocument(schema1, configuration1, NAMESPACE_URI_TEST, "", xsdFileNameGenerator);
		...
		Document xsdDocumentTestingNS = xsdGenerator.generateSchemaDocument(schema1, configuration1, NAMESPACE_URI_TESTING, "", xsdFileNameGenerator);
		String xsdOutputStringTestingNS = outputter.outputString(xsdDocumentTestingNS);
		
		String expectedOutputTestingNS="<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
...
//		System.out.println(xsdOutputString);
		String lineSeparator = System.getProperty("line.separator");
		String expectedOutputDefaultNS = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
			"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" elementFormDefault=\"qualified\"><xs:import namespace=\"http://probando.net\" /><xs:import namespace=\"http://prueba.net\" schemaLocation=\"schema-ns_test.xsd\" /><xs:simpleType name=\"_root-_element1-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"hasta luego\" /><xs:enumeration value=\"hola\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_a-SimpleType\"><xs:restriction base=\"xs:integer\"><xs:enumeration value=\"40\" /><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element1-_a-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /><xs:enumeration value=\"cuarenta\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"adios\" /><xs:enumeration value=\"buenos dias\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:complexType name=\"_root-_element1-_a\"><!--Comentario A--></xs:complexType><xs:complexType name=\"_root-_element1-_b\" /><xs:complexType name=\"_root-_element1-_c\"><xs:group ref=\"test:e-_root-_element1-_c-_e\" /></xs:complexType><xs:complexType name=\"_root-_element1-_c-_e\" /><xs:complexType name=\"_root-_element2-_a\" /><xs:complexType name=\"_root-_element2-_b\" /><xs:complexType name=\"_root-_element2-_c-_f\" /><xs:complexType name=\"_root-_element2-_d\" /><xs:complexType name=\"_root-_element2-_c\"><xs:sequence><xs:element name=\"f\" type=\"_root-_element2-_c-_f\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element2\"><xs:sequence><xs:element name=\"a\" type=\"_root-_element2-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element2-_b-SimpleType\" /><xs:group ref=\"test:c-_root-_element2-_c\" maxOccurs=\"unbounded\" minOccurs=\"1\" /><xs:element ref=\"testing:d\" /></xs:sequence><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attributeGroup ref=\"test:_root-_element2-attr2\" /><xs:attribute ref=\"testing:attr4\" /></xs:complexType><xs:complexType name=\"_root-_element1\"><!--Comentario 1--><!--Otro comentario 1--><xs:sequence><xs:choice><xs:element name=\"a\" type=\"_root-_element1-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element1-_b-SimpleType\" /></xs:choice><xs:group ref=\"test:c-_root-_element1-_c\" /></xs:sequence><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attributeGroup ref=\"test:_root-_element1-attr2\" /><xs:attribute name=\"attr3\" type=\"xs:boolean\" use=\"required\" /></xs:complexType><xs:complexType name=\"_root\"><xs:sequence><xs:element name=\"element1\" type=\"_root-_element1\" /><xs:element name=\"element2\" type=\"_root-_element2\" /></xs:sequence></xs:complexType><xs:element name=\"root\" type=\"_root\" /></xs:schema>"+lineSeparator;
//		for(int i=0;i<expectedOutput.length();i++){
//			if(expectedOutput.charAt(i)!=xsdOutputString.charAt(i))
//				System.err.println("Difference at index "+i+". Expected char is '"+expectedOutput.charAt(i)+"' but found is '"+xsdOutputString.charAt(i)+"'");
//		}
...
//		assertEquals(expectedOutputTestingNS, xsdOutputStringTestingNS);
	...
	/**
	 * Test that checks the XSD documents generated for the main namespace from a complex scenario when 
	 * there are elements and attributes of many namespaces and the workaround is not enabled.
	 */
	@Test
	public void testScenario1WholeXSDManyNamespacesNoWorkaround() {
		...
		when(configuration1.getSimpleTypesGlobal()).thenReturn(true);
		when(configuration1.getComplexTypesGlobal()).thenReturn(true);
		when(configuration1.getStrictValidRootDefinitionWorkaround()).thenReturn(false);
		XSDDocumentGeneratorFactory xsdDocumentGeneratorFactoryInstance = XSDDocumentGeneratorFactory.getInstance();
		XSDDocumentGenerator xsdGenerator = xsdDocumentGeneratorFactoryInstance.getXSDDocumentGeneratorInstance();
		Document xsdDocumentDefaultNS = xsdGenerator.generateSchemaDocument(schema1, configuration1, "", "", xsdFileNameGenerator);
		//Schema document is partially sorted so that problems related to unordered data structures are avoided
...
//		System.out.println(xsdOutputString);
		String lineSeparator = System	.getProperty("line.separator");
		String expectedOutputDefaultNS = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
			"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" elementFormDefault=\"qualified\"><xs:import namespace=\"http://probando.net\" schemaLocation=\"schema-ns_testing.xsd\" /><xs:import namespace=\"http://prueba.net\" schemaLocation=\"schema-ns_test.xsd\" /><xs:simpleType name=\"_root-_element1-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"hasta luego\" /><xs:enumeration value=\"hola\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_a-SimpleType\"><xs:restriction base=\"xs:integer\"><xs:enumeration value=\"40\" /><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element1-_a-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /><xs:enumeration value=\"cuarenta\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"adios\" /><xs:enumeration value=\"buenos dias\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:complexType name=\"_root-_element1-_a\"><!--Comentario A--></xs:complexType><xs:complexType name=\"_root-_element1-_b\" /><xs:complexType name=\"_root-_element1-_c\"><xs:sequence><xs:element ref=\"test:e\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element1-_c-_e\" /><xs:complexType name=\"_root-_element2-_a\" /><xs:complexType name=\"_root-_element2-_b\" /><xs:complexType name=\"_root-_element2-_c-_f\" /><xs:complexType name=\"_root-_element2-_d\" /><xs:complexType name=\"_root-_element2-_c\"><xs:sequence><xs:element name=\"f\" type=\"_root-_element2-_c-_f\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element2\"><xs:sequence><xs:element name=\"a\" type=\"_root-_element2-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element2-_b-SimpleType\" /><xs:element ref=\"test:c\" maxOccurs=\"unbounded\" minOccurs=\"1\" /><xs:element ref=\"testing:d\" /></xs:sequence><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute ref=\"test:attr2\" /><xs:attribute ref=\"testing:attr4\" /></xs:complexType><xs:complexType name=\"_root-_element1\"><!--Comentario 1--><!--Otro comentario 1--><xs:sequence><xs:choice><xs:element name=\"a\" type=\"_root-_element1-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element1-_b-SimpleType\" /></xs:choice><xs:element ref=\"test:c\" /></xs:sequence><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute ref=\"test:attr2\" /><xs:attribute name=\"attr3\" type=\"xs:boolean\" use=\"required\" /></xs:complexType><xs:complexType name=\"_root\"><xs:sequence><xs:element name=\"element1\" type=\"_root-_element1\" /><xs:element name=\"element2\" type=\"_root-_element2\" /></xs:sequence></xs:complexType><xs:element name=\"root\" type=\"_root\" /></xs:schema>"+lineSeparator;
//		for(int i=0;i<expectedOutput.length();i++){
//			if(expectedOutput.charAt(i)!=xsdOutputString.charAt(i))
//				System.err.println("Difference at index "+i+". Expected char is '"+expectedOutput.charAt(i)+"' but found is '"+xsdOutputString.charAt(i)+"'");
//		}
		...
		String expectedOutputTestNS="<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
				"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" targetNamespace=\"http://prueba.net\" elementFormDefault=\"qualified\"><xs:import schemaLocation=\"schema-no_ns.xsd\" /><xs:attribute name=\"attr2\" type=\"xs:integer\" /><xs:element name=\"c\" type=\"_root-_element1-_c\" /><xs:element name=\"e\" type=\"_root-_element1-_c-_e\" /></xs:schema>"+lineSeparator;
		assertEquals(expectedOutputTestNS, xsdOutputStringTestNS);
		...
		String expectedOutputTestingNS="<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
				"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" targetNamespace=\"http://probando.net\" elementFormDefault=\"qualified\"><xs:import schemaLocation=\"schema-no_ns.xsd\" /><xs:attribute name=\"attr4\" type=\"xs:string\" /><xs:element name=\"d\" type=\"_root-_element2-_d\" /></xs:schema>"+lineSeparator;
		assertEquals(expectedOutputTestingNS, xsdOutputStringTestingNS);
	}
	
	/**
	 * Test that checks the XSD generated for the main namespace from a complex scenario when only 
	 * the main namespace is known (although there are other declared namespaces) when complex types 
	 * are set to be locally declared.
	 */
	@Test
...
//		System.out.println(xsdOutputString);
		String lineSeparator = System.getProperty("line.separator");
		String expectedOutput = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
				"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" elementFormDefault=\"qualified\"><xs:simpleType name=\"_root-_element1-_a-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /><xs:enumeration value=\"cuarenta\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element1-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"hasta luego\" /><xs:enumeration value=\"hola\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_a-SimpleType\"><xs:restriction base=\"xs:integer\"><xs:enumeration value=\"40\" /><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"adios\" /><xs:enumeration value=\"buenos dias\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:element name=\"root\"><xs:complexType><xs:sequence><xs:element name=\"element1\"><xs:complexType><!--Comentario 1--><!--Otro comentario 1--><xs:sequence><xs:choice><xs:element name=\"a\" type=\"_root-_element1-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element1-_b-SimpleType\" /></xs:choice><xs:element name=\"c\"><xs:complexType><xs:sequence><xs:element name=\"e\"><xs:complexType /></xs:element></xs:sequence></xs:complexType></xs:element></xs:sequence><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"required\" /><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute name=\"attr3\" type=\"xs:boolean\" use=\"required\" /></xs:complexType></xs:element><xs:element name=\"element2\"><xs:complexType><xs:sequence><xs:element name=\"a\" type=\"_root-_element2-_a-SimpleType\" /><xs:element name=\"b\" type=\"_root-_element2-_b-SimpleType\" /><xs:element name=\"c\" maxOccurs=\"unbounded\" minOccurs=\"1\"><xs:complexType><xs:sequence><xs:element name=\"f\"><xs:complexType /></xs:element></xs:sequence></xs:complexType></xs:element><xs:element name=\"d\"><xs:complexType /></xs:element></xs:sequence><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"optional\" /><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute name=\"attr4\" type=\"xs:string\" use=\"optional\" /></xs:complexType></xs:element></xs:sequence></xs:complexType></xs:element></xs:schema>"+lineSeparator;
//		for(int i=0;i<expectedOutput.length();i++){
//			if(expectedOutput.charAt(i)!=xsdOutputString.charAt(i))
//				System.err.println("Difference at index "+i+". Expected char is '"+expectedOutput.charAt(i)+"' but found is '"+xsdOutputString.charAt(i)+"'");
//		}
	...
	/**
	 * Test that checks the XSD generated for the main namespace from a complex scenario when only 
	 * the main namespace is known (although there are other declared namespaces) when elements are 
	 * declared globally. 
	 */
	@Test
...
//		System.out.println(xsdOutputString);
		String lineSeparator = System.getProperty("line.separator");
		String expectedOutput = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
			"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" elementFormDefault=\"qualified\"><xs:simpleType name=\"_root-_element1-_a-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /><xs:enumeration value=\"cuarenta\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element1-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"hasta luego\" /><xs:enumeration value=\"hola\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_a-SimpleType\"><xs:restriction base=\"xs:integer\"><xs:enumeration value=\"40\" /><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /></xs:restriction></xs:simpleType><xs:simpleType name=\"_root-_element2-_b-SimpleType\"><xs:restriction base=\"xs:string\"><xs:enumeration value=\"adios\" /><xs:enumeration value=\"buenos dias\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType><xs:complexType name=\"_root-_element1-_c\"><xs:sequence><xs:element ref=\"e\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element1-_b\" /><xs:complexType name=\"_root-_element1-_a\"><!--Comentario A--></xs:complexType><xs:complexType name=\"_root-_element1-_c-_e\" /><xs:complexType name=\"_root-_element2-_d\" /><xs:complexType name=\"_root-_element2-_c\"><xs:sequence><xs:element ref=\"f\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element2\"><xs:sequence><xs:element ref=\"a\" /><xs:element ref=\"b\" /><xs:element ref=\"c\" maxOccurs=\"unbounded\" minOccurs=\"1\" /><xs:element ref=\"d\" /></xs:sequence><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"optional\" /><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute name=\"attr4\" type=\"xs:string\" use=\"optional\" /></xs:complexType><xs:complexType name=\"_root-_element1\"><!--Comentario 1--><!--Otro comentario 1--><xs:sequence><xs:choice><xs:element ref=\"a\" /><xs:element ref=\"b\" /></xs:choice><xs:element ref=\"c\" /></xs:sequence><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"required\" /><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute name=\"attr3\" type=\"xs:boolean\" use=\"required\" /></xs:complexType><xs:complexType name=\"_root\"><xs:sequence><xs:element ref=\"element1\" /><xs:element ref=\"element2\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element2-_a\" /><xs:complexType name=\"_root-_element2-_b\" /><xs:complexType name=\"_root-_element2-_c-_f\" /><xs:element name=\"b\" type=\"_root-_element1-_b-SimpleType\" /><xs:element name=\"a\" type=\"_root-_element1-_a-SimpleType\" /><xs:element name=\"d\" type=\"_root-_element2-_d\" /><xs:element name=\"c\" type=\"_root-_element1-_c\" /><xs:element name=\"element1\" type=\"_root-_element1\" /><xs:element name=\"root\" type=\"_root\" /><xs:element name=\"element2\" type=\"_root-_element2\" /><xs:element name=\"e\" type=\"_root-_element1-_c-_e\" /><xs:element name=\"f\" type=\"_root-_element2-_c-_f\" /></xs:schema>"+lineSeparator;
//		for(int i=0;i<expectedOutput.length();i++){
//			if(expectedOutput.charAt(i)!=xsdOutputString.charAt(i))
//				System.err.println("Difference at index "+i+". Expected char is '"+expectedOutput.charAt(i)+"' but found is '"+xsdOutputString.charAt(i)+"'");
//		}
	...
	/**
	 * Test that checks the XSD generated for the main namespace from a complex scenario when only 
	 * the main namespace is known (although there are other declared namespaces) when simple types 
	 * are set to be locally declared.
	 */
	@Test
...
//		System.out.println(xsdOutputString);
		String lineSeparator = System.getProperty("line.separator");
		String expectedOutput = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
			"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" elementFormDefault=\"qualified\"><xs:complexType name=\"_root\"><xs:sequence><xs:element name=\"element1\" type=\"_root-_element1\" /><xs:element name=\"element2\" type=\"_root-_element2\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element1\"><!--Comentario 1--><!--Otro comentario 1--><xs:sequence><xs:choice><xs:element name=\"a\"><xs:simpleType><xs:restriction base=\"xs:string\"><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /><xs:enumeration value=\"cuarenta\" /></xs:restriction></xs:simpleType></xs:element><xs:element name=\"b\"><xs:simpleType><xs:restriction base=\"xs:string\"><xs:enumeration value=\"hasta luego\" /><xs:enumeration value=\"hola\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType></xs:element></xs:choice><xs:element name=\"c\" type=\"_root-_element1-_c\" /></xs:sequence><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"required\" /><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute name=\"attr3\" type=\"xs:boolean\" use=\"required\" /></xs:complexType><xs:complexType name=\"_root-_element1-_a\"><!--Comentario A--></xs:complexType><xs:complexType name=\"_root-_element1-_b\" /><xs:complexType name=\"_root-_element1-_c\"><xs:sequence><xs:element name=\"e\" type=\"_root-_element1-_c-_e\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element1-_c-_e\" /><xs:complexType name=\"_root-_element2\"><xs:sequence><xs:element name=\"a\"><xs:simpleType><xs:restriction base=\"xs:integer\"><xs:enumeration value=\"40\" /><xs:enumeration value=\"50\" /><xs:enumeration value=\"60\" /><xs:enumeration value=\"70\" /></xs:restriction></xs:simpleType></xs:element><xs:element name=\"b\"><xs:simpleType><xs:restriction base=\"xs:string\"><xs:enumeration value=\"adios\" /><xs:enumeration value=\"buenos dias\" /><xs:enumeration value=\"saludos\" /></xs:restriction></xs:simpleType></xs:element><xs:element name=\"c\" type=\"_root-_element2-_c\" maxOccurs=\"unbounded\" minOccurs=\"1\" /><xs:element name=\"d\" type=\"_root-_element2-_d\" /></xs:sequence><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"optional\" /><xs:attribute name=\"attr1\" type=\"xs:string\" use=\"required\" /><xs:attribute name=\"attr4\" type=\"xs:string\" use=\"optional\" /></xs:complexType><xs:complexType name=\"_root-_element2-_a\" /><xs:complexType name=\"_root-_element2-_b\" /><xs:complexType name=\"_root-_element2-_c\"><xs:sequence><xs:element name=\"f\" type=\"_root-_element2-_c-_f\" /></xs:sequence></xs:complexType><xs:complexType name=\"_root-_element2-_c-_f\" /><xs:complexType name=\"_root-_element2-_d\" /><xs:element name=\"root\" type=\"_root\" /></xs:schema>"+lineSeparator;
//		for(int i=0;i<expectedOutput.length();i++){
//			if(expectedOutput.charAt(i)!=xsdOutputString.charAt(i))
//				System.err.println("Difference at index "+i+". Expected char is '"+expectedOutput.charAt(i)+"' but found is '"+xsdOutputString.charAt(i)+"'");
//		}
	...
	public void testScenario1WholeXSDManyNamespacesWorkaroundCTSTLocal() {
		...
		prefixNamespaceMapping.put(NAMESPACE_URI_TESTING, new TreeSet<>(Collections.singleton("testing")));
		Table<String, String, SchemaElement> elements = schema1.getElements();
		elements.put(NAMESPACE_URI_TEST, "_root-_element1-b", elementScenario1Element1B);
		elements.put(NAMESPACE_URI_TEST, "_root-_element1-c", elementScenario1Element1C);
		elements.put(NAMESPACE_URI_TEST, "_root-_element1-_c-e", elementScenario1Element1CE);
		elements.put(NAMESPACE_URI_TEST, "_root-_element2-c", elementScenario1Element2C);
		elements.put(NAMESPACE_URI_TESTING, "_root-_element2-d", elementScenario1Element2D);
...
//		}
		...
		String expectedOutputTestNS="<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
				"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" targetNamespace=\"http://prueba.net\" elementFormDefault=\"qualified\"><xs:import schemaLocation=\"schema-no_ns.xsd\" /><xs:attributeGroup name=\"_root-_element2-attr2\"><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"optional\" form=\"qualified\" /></xs:attributeGroup><xs:attributeGroup name=\"_root-_element1-attr2\"><xs:attribute name=\"attr2\" type=\"xs:integer\" use=\"required\" form=\"qualified\" /></xs:attributeGroup><xs:group name=\"b-_root-_element1-_b\"><xs:sequence><xs:element name=\"b\"><xs:simpleType><xs:restriction base=\"xs:string\"><xs:enumeration value=\"hola\" /><xs:enumeration value=\"saludos\" /><xs:enumeration value=\"hasta luego\" /></xs:restriction></xs:simpleType></xs:element></xs:sequence></xs:group><xs:group name=\"c-_root-_element1-_c\"><xs:sequence><xs:element name=\"c\"><xs:complexType><xs:group ref=\"test:e-_root-_element1-_c-_e\" /></xs:complexType></xs:element></xs:sequence></xs:group><xs:group name=\"e-_root-_element1-_c-_e\"><xs:sequence><xs:element name=\"e\"><xs:complexType /></xs:element></xs:sequence></xs:group><xs:group name=\"c-_root-_element2-_c\"><xs:sequence><xs:element name=\"c\"><xs:complexType><xs:sequence><xs:element name=\"f\"><xs:complexType /></xs:element></xs:sequence></xs:complexType></xs:element></xs:sequence></xs:group></xs:schema>"+lineSeparator;
		assertEquals(expectedOutputTestNS, xsdOutputStringTestNS);
		...
		String expectedOutputTestingNS="<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
				"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" targetNamespace=\"http://probando.net\" elementFormDefault=\"qualified\"><xs:import schemaLocation=\"schema-no_ns.xsd\" /><xs:attributeGroup name=\"_root-_element2-attr4\"><xs:attribute name=\"attr4\" type=\"xs:string\" use=\"optional\" form=\"qualified\" /></xs:attributeGroup><xs:group name=\"d-_root-_element2-_d\"><xs:sequence><xs:element name=\"d\"><xs:complexType /></xs:element></xs:sequence></xs:group></xs:schema>"+lineSeparator;
		assertEquals(expectedOutputTestingNS, xsdOutputStringTestingNS);
	}
	...
	/**
	 * Test that checks that the XSDs for scenario 2 are generated correctly. This scenario consists of two 
	 * empty root elements of different namespaces.
	 */
	@Test
	public void testScenario2Normal(){
		...
		when(configuration2.getStrictValidRootDefinitionWorkaround()).thenReturn(true); //VERY IMPORTANT, because elements MUST be declared globally and not be wrapped into groups
		...
		Document xsdDocumentTestNS = xsdGenerator.generateSchemaDocument(schema2, configuration2, NAMESPACE_URI_TEST, NAMESPACE_URI_TEST, xsdFileNameGenerator);
		String xsdOutputStringTestNS = outputter.outputString(xsdDocumentTestNS);
		
		String expectedOutputTestNS="<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
				"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" targetNamespace=\"http://prueba.net\" elementFormDefault=\"qualified\"><xs:import namespace=\"http://probando.net\" schemaLocation=\"schema-ns_testing.xsd\" /><xs:complexType name=\"testing_raiz\" /><xs:complexType name=\"test_root\" /><xs:element name=\"root\" type=\"test:test_root\" /></xs:schema>"+lineSeparator;
		assertEquals(expectedOutputTestNS, xsdOutputStringTestNS);
		
		Document xsdDocumentTestingNS = xsdGenerator.generateSchemaDocument(schema2, configuration2, NAMESPACE_URI_TESTING, NAMESPACE_URI_TEST, xsdFileNameGenerator);
		String xsdOutputStringTestingNS = outputter.outputString(xsdDocumentTestingNS);
		
		String expectedOutputTestingNS="<?xml version=\"1.0\" encoding=\"UTF-8\"?>"+ lineSeparator +
				"<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" xmlns:test=\"http://prueba.net\" xmlns:testing=\"http://probando.net\" targetNamespace=\"http://probando.net\" elementFormDefault=\"qualified\"><xs:import namespace=\"http://prueba.net\" schemaLocation=\"schema-ns_test.xsd\" /><xs:element name=\"raiz\" type=\"test:testing_raiz\" /></xs:schema>"+lineSeparator;
		assertEquals(expectedOutputTestingNS, xsdOutputStringTestingNS);
