...
/**
 * Test for {@link TypesExtractor} and its implementation {@link TypesExtractorImpl} which DOES use mocks for submodules, 
 * so that only the main module is tested.
 * @author Pablo Alonso Rodriguez (Center for Open Middleware)
 */
public class TypesExtractorImplTest {
	...
	//Mocks and objects generated by mock inferencers
	
	//Scenario 1
	
	/**
	 * Mocked {@link InferencersFactory} for the first scenario
	 */
	private InferencersFactory mockInferencersFactoryScenario1;	
	
	/**
	 * Simple type of attr1 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1Attr1;
	
	/**
	 * Simple type of attr2 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1Attr2;
	
	/**
	 * Simple type of attr3 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1Attr3;
	
	/**
	 * Simple type of test:attr4 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1TestAttr4;
	
	/**
	 * Simple type of attr5 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1Attr5;
	
	/**
	 * Simple type of element1 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1Element1;
	
	/**
	 * Simple type of element2 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1Element2;
	
	/**
	 * Simple type of element3 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1Element3;
	
	/**
	 * Simple type of test:element3 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1TestElement3;
	
	/**
	 * Simple type of test:element4 on the first scenario.
	 */
	private SimpleType simpleTypeScenario1TestElement4;
	
	/**
	 * Simple type of root on the first scenario.
	 */
	private SimpleType simpleTypeScenario1Root;
	
	/**
	 * Mock simple type inferencer of attr1 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1Attr1;

	/**
	 * Mock simple type inferencer of attr2 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1Attr2;

	/**
	 * Mock simple type inferencer of attr3 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1Attr3;

	/**
	 * Mock simple type inferencer of test:attr4 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1TestAttr4;

	/**
	 * Mock simple type inferencer of attr5 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1Attr5;

	/**
	 * Mock simple type inferencer of element1 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1Element1;

	/**
	 * Mock simple type inferencer of element2 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1Element2;
	
	/**
	 * Mock simple type inferencer of element3 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1Element3;
	
	/**
	 * Mock simple type inferencer of test:element3 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1TestElement3;
	
	/**
	 * Mock simple type inferencer of test:element4 on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1TestElement4;
	
	/**
	 * Mock simple type inferencer of root on the first scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario1Root;
	
	/**
	 * {@link SchemaAttribute} object for attr1 on scenario 1
	 */
	private SchemaAttribute schemaAttributeScenario1Attr1;
	
	/**
	 * {@link SchemaAttribute} object for attr2 on scenario 1
	 */
	private SchemaAttribute schemaAttributeScenario1Attr2;
	
	/**
	 * {@link SchemaAttribute} object for attr3 on scenario 1
	 */
	private SchemaAttribute schemaAttributeScenario1Attr3;
	
	/**
	 * {@link SchemaAttribute} object for test:attr4 on scenario 1
	 */
	private SchemaAttribute schemaAttributeScenario1TestAttr4;
	
	/**
	 * {@link SchemaAttribute} object for attr5 on scenario 1
	 */
	private SchemaAttribute schemaAttributeScenario1Attr5;
	
	/**
	 * Attribute list of element1 on the first scenario
	 */
	private List<SchemaAttribute> attributeListScenario1Element1;
	
	/**
	 * Attribute list of element3 on the first scenario
	 */
	private List<SchemaAttribute> attributeListScenario1Element3;
	
	/**
	 * Attribute list inferencer of element1 on the first scenario
	 */
	private AttributeListInferencer attributeListInferencerScenario1Element1;
	
	/**
	 * Attribute list inferencer of element3 on the first scenario
	 */
	private AttributeListInferencer attributeListInferencerScenario1Element3;
	
	/**
	 *  Mock attribute list inferencer for elements without attributes. It always returns an empty list.
	 *  It may be used on all the scenarios.
	 */
	private AttributeListInferencer attributeListInferencerEmpty;
	
	/**
	 * BasicStatisticsEntry for attr1 of the first scenario (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr1;
	
	/**
	 * BasicStatisticsEntry for attr2 of the first scenario (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr2;
	
	/**
	 * BasicStatisticsEntry for attr3 of the first scenario (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr3;
	
	/**
	 * BasicStatisticsEntry for test:attr4 of the first scenario (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1TestAttr4;
	
	/**
	 * BasicStatisticsEntry for attr5 of the first scenario (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr5;
	
	/**
	 * BasicStatisticsEntry for value '5' on attr1 of the first scenario 
	 * (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr1Value5;
	
	/**
	 * BasicStatisticsEntry for value '6' on attr1 of the first scenario 
	 * (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr1Value6;
	
	/**
	 * BasicStatisticsEntry for value 'hola' on attr2 of the first scenario
	 * (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr2ValueHola;
	
	/**
	 * BasicStatisticsEntry for value 'buenas' on attr3 of the first scenario 
	 * (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr3ValueBuenas;
	
	/**
	 * BasicStatisticsEntry for value 'con namespace' on test:attr4 of the first 
	 * scenario (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1TestAttr4ValueConNamespace;
	
	/**
	 * BasicStatisticsEntry for value '7' on attr5 of the first scenario 
	 * (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario1Attr5Value7;
	
	//Scenario 2 
	
	/**
	 * Mocked {@link InferencersFactory} for the second scenario
	 */
	private InferencersFactory mockInferencersFactoryScenario2;	
	
	/**
	 * Simple type of root on the second scenario.
	 */
	private SimpleType simpleTypeScenario2Root;
	
	/**
	 * Simple type of raiz on the second scenario.
	 */
	private SimpleType simpleTypeScenario2Raiz;
	
	/**
	 * Simple type of a on the second scenario.
	 */
	private SimpleType simpleTypeScenario2A;
	
	/**
	 * Simple type of b on the second scenario.
	 */
	private SimpleType simpleTypeScenario2B;
	
	/**
	 * Simple type of c on the second scenario.
	 */
	private SimpleType simpleTypeScenario2C;
	
	/**
	 * Simple type of d on the second scenario.
	 */
	private SimpleType simpleTypeScenario2D;
	
	/**
	 * Simple type of e on the second scenario.
	 */
	private SimpleType simpleTypeScenario2E;
	
	/**
	 * Simple type of attr on the second scenario.
	 */
	private SimpleType simpleTypeScenario2Attr;

	/**
	 * Mock simple type inferencer of root on the second scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario2Root;
	
	/**
	 * Mock simple type inferencer of raiz on the second scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario2Raiz;
	
	/**
	 * Mock simple type inferencer of a on the second scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario2A;
	
	/**
	 * Mock simple type inferencer of b on the second scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario2B;
	
	/**
	 * Mock simple type inferencer of c on the second scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario2C;
	
	/**
	 * Mock simple type inferencer of d on the second scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario2D;
	
	/**
	 * Mock simple type inferencer of e on the second scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario2E;
	
	/**
	 * Mock simple type inferencer of attr on the second scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario2Attr;
	
	/**
	 * {@link SchemaAttribute} object for attr on scenario 2
	 */
	private SchemaAttribute schemaAttributeScenario2Attr;
	
	/**
	 * Attribute list of raiz on the second scenario
	 */
	private List<SchemaAttribute> attributeListScenario2Raiz;
	
	/**
	 * Attribute list inferencer of raiz on the second scenario
	 */
	private AttributeListInferencer attributeListInferencerScenario2Raiz;

	/**
	 * BasicStatisticsEntry for attr of the second scenario (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario2Attr;
	
	/**
	 * BasicStatisticsEntry for value 'value' on attr of the second scenario 
	 * (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario2AttrValueValue;
	
	//Scenario 3
	
	/**
	 * Mocked {@link InferencersFactory} for the third scenario
	 */
	private InferencersFactory mockInferencersFactoryScenario3;	
	
	
	/**
	 * Simple type of nodoRaiz on the third scenario.
	 */
	private SimpleType simpleTypeScenario3NodoRaiz;
	
	/**
	 * Simple type of nodoRaiz on the third scenario.
	 */
	private SimpleType simpleTypeScenario3Attr;
	
	/**
	 * Mock simple type inferencer of nodoRaiz on the third scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario3NodoRaiz;
	
	/**
	 * Mock simple type inferencer of attr on the third scenario.
	 */
	private SimpleTypeInferencer simpleTypeInferencerScenario3Attr;
	
	/**
	 * {@link SchemaAttribute} object for attr on scenario 3
	 */
	private SchemaAttribute schemaAttributeScenario3Attr;
	
	/**
	 * Attribute list of nodoRaiz on the third scenario
	 */
	private List<SchemaAttribute> attributeListScenario3NodoRaiz;
	
	/**
	 * Attribute list inferencer of nodoRaiz on the third scenario
	 */
	private AttributeListInferencer attributeListInferencerScenario3NodoRaiz;

	/**
	 * BasicStatisticsEntry for attr of the third scenario (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario3Attr;
	
	/**
	 * BasicStatisticsEntry for value 'value' on attr of the third scenario 
	 * (which normally is added by the attribute list inferencer).
	 * It can be used at both statisics per path and per complex type
	 */
	private BasicStatisticsEntry basicStatisticsEntryScenario3AttrValueValue;
	
	
	//Some useful constants to build BasicStatisticsEntry objects
	
	/**
	 * Occurrences list to build some {@link BasicStatisticsEntry} objects related to attributes and their values.
	 * At this one, the attribute/value occurs once at both documents
	 */
	private static final List<Double> OCCURRENCES_LIST_ONCE_AT_BOTH_DOCS = ImmutableList.of(1.0, 1.0);
	
	/**
	 * Occurrences list to build some {@link BasicStatisticsEntry} objects related to attributes and their values.
	 * At this one, the attribute/value occurs once at the first document
	 */
	private static final List<Double> OCCURRENCES_LIST_ONCE_AT_FIRST_DOC = ImmutableList.of(1.0, 0.0);
	
	/**
	 * Occurrences list to build some {@link BasicStatisticsEntry} objects related to attributes and their values.
	 * At this one, the attribute/value occurs once at the second document
	 */
	private static final List<Double> OCCURRENCES_LIST_ONCE_AT_SECOND_DOC = ImmutableList.of(1.0, 0.0);
	
	
	//First scenario mocks preparing
	
	/**
	 * It builds the SimpleType objects of the first scenario, which should be returned by the SimpleTypeInferencer mocks
	 */
	private void buildSimpleTypesScenario1(){
		simpleTypeScenario1Attr1 = new SimpleType("_root-_element1-@_attr1", "xs:integer", ImmutableSet.of("5", "6"),false);
		simpleTypeScenario1Attr2 = new SimpleType("_root-_element1-@_attr2", "xs:string", ImmutableSet.of("hola"),false);
		simpleTypeScenario1Attr3 = new SimpleType("_root-_element1-@_attr3", "xs:string", ImmutableSet.of("buenas"),false);
		simpleTypeScenario1TestAttr4 = new SimpleType("_root-_element1-@test_attr4", "xs:string", ImmutableSet.of("con namespace"),false);
		simpleTypeScenario1Attr5 = new SimpleType("_root-_element3-@_attr5", "xs:integer", ImmutableSet.of("7"),false);
		simpleTypeScenario1Element1 = new SimpleType("_root-_element1", "xs:string", ImmutableSet.of("value1", "probando probando 123"),false);
		simpleTypeScenario1Element2 = new SimpleType("_root-unprefixed1_element2", "xs:boolean", ImmutableSet.of("true", "false"),false);
		simpleTypeScenario1Element3 = new SimpleType("_root-_element3", "", ImmutableSet.<String>of(),false);
		simpleTypeScenario1TestElement3 = new SimpleType("_root-test_element3", "", ImmutableSet.<String>of(),false);
		simpleTypeScenario1TestElement4 = new SimpleType("_root-test_element4", "", ImmutableSet.<String>of(),false);
		simpleTypeScenario1Root = new SimpleType("_root", "xs:string", ImmutableSet.of("\r\n\t\r\n\t\r\n\t\r\n\t\r\n","\r\n\t\r\n\t\r\n\t\r\n\t\r\n\t\r\n"),false);
	}
	
	/**
	 * Method that builds the simple type infrencers for the first scenario
	 */
	private void buildSimpleTypeInferencersScenario1(){
		simpleTypeInferencerScenario1Attr1 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1Attr1.getSimpleType("_root-_element1-_attr1-SimpleTypeOfAttribute")).thenReturn(simpleTypeScenario1Attr1);
		
		simpleTypeInferencerScenario1Attr2 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1Attr2.getSimpleType("_root-_element1-_attr2-SimpleTypeOfAttribute")).thenReturn(simpleTypeScenario1Attr2);
		
		simpleTypeInferencerScenario1Attr3 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1Attr3.getSimpleType("_root-_element1-_attr3-SimpleTypeOfAttribute")).thenReturn(simpleTypeScenario1Attr3);
		
		simpleTypeInferencerScenario1TestAttr4 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1TestAttr4.getSimpleType("_root-_element1-_TestAttr4-SimpleTypeOfAttribute")).thenReturn(simpleTypeScenario1TestAttr4);
		
		simpleTypeInferencerScenario1Attr5 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1Attr5.getSimpleType("_root-_element1-_attr5-SimpleTypeOfAttribute")).thenReturn(simpleTypeScenario1Attr5);
		
		simpleTypeInferencerScenario1Element1 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1Element1.getSimpleType("_root-_element1")).thenReturn(simpleTypeScenario1Element1);
		
		simpleTypeInferencerScenario1Element2 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1Element2.getSimpleType("_root-unprefixed1_element2")).thenReturn(simpleTypeScenario1Element2);
		
		simpleTypeInferencerScenario1Element3 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1Element3.getSimpleType("_root-_element3")).thenReturn(simpleTypeScenario1Element3);
		
		simpleTypeInferencerScenario1TestElement3 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1TestElement3.getSimpleType("_root-test_element3")).thenReturn(simpleTypeScenario1TestElement3);
		
		simpleTypeInferencerScenario1TestElement4 = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1TestElement4.getSimpleType("_root-test_element4")).thenReturn(simpleTypeScenario1TestElement4);
		
		simpleTypeInferencerScenario1Root = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario1Root.getSimpleType("_root")).thenReturn(simpleTypeScenario1Root);
	}
	
	/**
	 * Method that builds the {@link SchemaAttribute} objects and the attribute lists on the first scenario
	 */
	private void buildSchemaAttributesAndAttributeListsScenario1(){
		schemaAttributeScenario1Attr1 = new SchemaAttribute("attr1", "", false, simpleTypeScenario1Attr1);
		schemaAttributeScenario1Attr2 = new SchemaAttribute("attr2", "", true, simpleTypeScenario1Attr2);
		schemaAttributeScenario1Attr3 = new SchemaAttribute("attr3", "", true, simpleTypeScenario1Attr3);
		schemaAttributeScenario1TestAttr4 = new SchemaAttribute("attr4", "http://prueba.net", true, simpleTypeScenario1TestAttr4);
		schemaAttributeScenario1Attr5 = new SchemaAttribute("attr5", "", true, simpleTypeScenario1Attr5);
		
		attributeListScenario1Element1 = Lists.newArrayList(schemaAttributeScenario1Attr1,schemaAttributeScenario1Attr2,schemaAttributeScenario1Attr3,schemaAttributeScenario1TestAttr4);
		attributeListScenario1Element3 = Lists.newArrayList(schemaAttributeScenario1Attr5);
	}
	
	/**
	 * Method that builds the attribute list inferencers of the first scenario.
	 */
	private void buildAttributeListInferencersScenario1(){
		
		attributeListInferencerScenario1Element1 = mock(AttributeListInferencer.class);
		when(attributeListInferencerScenario1Element1.getAttributesList()).thenReturn(attributeListScenario1Element1);
		
		attributeListInferencerScenario1Element3 = mock(AttributeListInferencer.class);
		when(attributeListInferencerScenario1Element3.getAttributesList()).thenReturn(attributeListScenario1Element3);
		
		attributeListInferencerEmpty = mock(AttributeListInferencer.class);
		when(attributeListInferencerEmpty.getAttributesList()).thenReturn(new ArrayList<SchemaAttribute>(1));
	}
	
	/**
	 * Method that builds the {@link BasicStatisticsEntry} objects related to attributes for the first scenario
	 */
	private void buildAttributeBasicStatisticsEntriesScenario1(){
		basicStatisticsEntryScenario1Attr1 = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_BOTH_DOCS);
		basicStatisticsEntryScenario1Attr2 = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_FIRST_DOC);
		basicStatisticsEntryScenario1Attr3 = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
		basicStatisticsEntryScenario1TestAttr4 = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
		basicStatisticsEntryScenario1Attr5 = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
		
		basicStatisticsEntryScenario1Attr1Value5 = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_FIRST_DOC);
		basicStatisticsEntryScenario1Attr1Value6 = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
		basicStatisticsEntryScenario1Attr2ValueHola = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_FIRST_DOC);
		basicStatisticsEntryScenario1Attr3ValueBuenas = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
		basicStatisticsEntryScenario1TestAttr4ValueConNamespace = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
		basicStatisticsEntryScenario1Attr5Value7 = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
	}
	
	/**
	 * Method that builds the {@link InferencersFactory} mock for the first scenario, which 
	 * returns the corresponding {@link SimpleTypeInferencer} and {@link AttributeListInferencer} 
	 * mocks.
	 */
	private void buildInferencersFactoryScenario1(){
		mockInferencersFactoryScenario1 = mock(InferencersFactory.class);
		
		//SimpleTypeInferencers
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-_element1-@_attr1"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1Attr1);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-_element1-@_attr2"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1Attr2);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-_element1-@_attr3"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1Attr3);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-_element1-@test_attr4"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1TestAttr4);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-_element3-@_attr5"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1Attr5);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-_element1"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1Element1);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-unprefixed1_element2"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1Element2);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-_element3"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1Element3);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-test_element3"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1TestElement3);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root-test_element4"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1TestElement4);
		
		when(mockInferencersFactoryScenario1.getSimpleTypeInferencerInstance(eq("_root"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario1Root);
		
		//AttributeListInferencers
		when(mockInferencersFactoryScenario1.getAttributeListInferencerInstance((Matchers.eq("_root-_element1")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerScenario1Element1);
		
		when(mockInferencersFactoryScenario1.getAttributeListInferencerInstance((Matchers.eq("_root-_element3")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerScenario1Element3);
		
		when(mockInferencersFactoryScenario1.getAttributeListInferencerInstance((Matchers.eq("_root-unprefixed1_element2")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
			
		when(mockInferencersFactoryScenario1.getAttributeListInferencerInstance((Matchers.eq("_root-test_element3")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
		
		when(mockInferencersFactoryScenario1.getAttributeListInferencerInstance((Matchers.eq("_root-test_element4")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
		
		when(mockInferencersFactoryScenario1.getAttributeListInferencerInstance((Matchers.eq("_root")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
	...
	/**
	 * Method that builds almost everything of the scenario 1 
	 * (except for the configuration and some other details)
	 */
	private void buildAllMocksAndObjectsForScenario1(){
		buildSimpleTypesScenario1();
		buildSimpleTypeInferencersScenario1();
		buildSchemaAttributesAndAttributeListsScenario1();
		buildAttributeListInferencersScenario1();
		buildAttributeBasicStatisticsEntriesScenario1();
		buildInferencersFactoryScenario1();
	}
	
	/**
	 * Method that adds {@link BasicStatisticsEntry} objects related to attributes
	 * of the scenario 1, which have not been added previously by the {@link AttributeListInferencer} 
	 * mock, but are expected by {@link TypesExtractor} implementations.
	 * @param schema the current {@link Schema}
	 */
	private void appendMissingBasicStatisticsEntriesOfAttributesScenario1(Schema schema){
		...
		ComplexType complexTypeElement1 = schema.getComplexTypes().get("_root-_element1");
		ComplexType complexTypeElement3 = schema.getComplexTypes().get("_root-_element3");
		ComplexTypeStatisticsEntry complexTypeElement1StatisticsEntry = complexTypeInfo.get(complexTypeElement1);
		ComplexTypeStatisticsEntry complexTypeElement3StatisticsEntry = complexTypeInfo.get(complexTypeElement3);
		SchemaAttribute attr1 = schema.getAttributes().get("", "_root-_element1-attr1");
		SchemaAttribute attr2 = schema.getAttributes().get("", "_root-_element1-attr2");
		SchemaAttribute attr3 = schema.getAttributes().get("", "_root-_element1-attr3");
		SchemaAttribute testAttr4 = schema.getAttributes().get("http://prueba.net", "_root-_element1-attr4");
		SchemaAttribute attr5 = schema.getAttributes().get("", "_root-_element3-attr5");
		
		attributeAtPathInfo.put("/root/element1/@attr1", basicStatisticsEntryScenario1Attr1);
		complexTypeElement1StatisticsEntry.getAttributeOccurrencesInfo().put(attr1, basicStatisticsEntryScenario1Attr1);
		valuesAtPathInfo.put("/root/element1/@attr1", "5", basicStatisticsEntryScenario1Attr1Value5);
		valuesAtPathInfo.put("/root/element1/@attr1", "6", basicStatisticsEntryScenario1Attr1Value6);
		complexTypeElement1StatisticsEntry.getValuesInfo().put("5", attr1, basicStatisticsEntryScenario1Attr1Value5);
		complexTypeElement1StatisticsEntry.getValuesInfo().put("6", attr1, basicStatisticsEntryScenario1Attr1Value6);
		
		attributeAtPathInfo.put("/root/element1/@attr2", basicStatisticsEntryScenario1Attr2);
		complexTypeElement1StatisticsEntry.getAttributeOccurrencesInfo().put(attr2, basicStatisticsEntryScenario1Attr2);
		valuesAtPathInfo.put("/root/element1/@attr2", "hola", basicStatisticsEntryScenario1Attr2ValueHola);
		complexTypeElement1StatisticsEntry.getValuesInfo().put("hola", attr2, basicStatisticsEntryScenario1Attr2ValueHola);
		
		attributeAtPathInfo.put("/root/element1/@attr3", basicStatisticsEntryScenario1Attr3);
		complexTypeElement1StatisticsEntry.getAttributeOccurrencesInfo().put(attr3, basicStatisticsEntryScenario1Attr3);
		valuesAtPathInfo.put("/root/element1/@attr3", "buenas", basicStatisticsEntryScenario1Attr3ValueBuenas);
		complexTypeElement1StatisticsEntry.getValuesInfo().put("buenas", attr3, basicStatisticsEntryScenario1Attr3ValueBuenas);
		
		attributeAtPathInfo.put("/root/element1/@test:attr4", basicStatisticsEntryScenario1TestAttr4);
		complexTypeElement1StatisticsEntry.getAttributeOccurrencesInfo().put(testAttr4, basicStatisticsEntryScenario1TestAttr4);
		valuesAtPathInfo.put("/root/element1/@test:attr4", "con namespace", basicStatisticsEntryScenario1TestAttr4ValueConNamespace);
		complexTypeElement1StatisticsEntry.getValuesInfo().put("con namespace", testAttr4, basicStatisticsEntryScenario1TestAttr4ValueConNamespace);
		
		attributeAtPathInfo.put("/root/element3/@attr5", basicStatisticsEntryScenario1Attr5);
		complexTypeElement3StatisticsEntry.getAttributeOccurrencesInfo().put(attr5, basicStatisticsEntryScenario1Attr5);
		valuesAtPathInfo.put("/root/element3/@attr5", "7", basicStatisticsEntryScenario1Attr5Value7);
		complexTypeElement3StatisticsEntry.getValuesInfo().put("7", attr5, basicStatisticsEntryScenario1Attr5Value7);
	}
	
	//Second scenario mocks preparing
	
	/**
	 * It builds the SimpleType objects of the second scenario, which should be returned by the SimpleTypeInferencer mocks
	 */
	private void buildSimpleTypesScenario2(){
		simpleTypeScenario2Root = new SimpleType("_root","",ImmutableSet.of("\r\n\t\r\n\t\r\n\t\r\n\t\r\n"),false);
		simpleTypeScenario2Raiz = new SimpleType("_raiz","",ImmutableSet.of("\r\n\t\r\n\t\r\n\t\r\n\t\r\n"),false);
		simpleTypeScenario2A = new SimpleType("_a","xs:string",ImmutableSet.of("","0"),false);
		simpleTypeScenario2B = new SimpleType("_b","xs:string",ImmutableSet.of("cosilla",""),false);
		simpleTypeScenario2C = new SimpleType("_c","xs:string",ImmutableSet.of("Esta cosa",""),false);
		simpleTypeScenario2D = new SimpleType("_d","",ImmutableSet.<String>of(),false);
		simpleTypeScenario2E = new SimpleType("_e","",ImmutableSet.<String>of(),false);
		simpleTypeScenario2Attr = new SimpleType("_raiz-@_attr","xs:string",ImmutableSet.of("value"),false);
	}
	
	/**
	 * Method that builds the simple type inferencers used on scenario 2
	 */
	private void buildSimpleTypeInferencersScenario2(){
		
		simpleTypeInferencerScenario2Root = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario2Root.getSimpleType("_root")).thenReturn(simpleTypeScenario2Root);
		
		simpleTypeInferencerScenario2Raiz = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario2Raiz.getSimpleType("_raiz")).thenReturn(simpleTypeScenario2Raiz);
		
		simpleTypeInferencerScenario2A = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario2A.getSimpleType("_a")).thenReturn(simpleTypeScenario2A);
		
		simpleTypeInferencerScenario2B = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario2B.getSimpleType("_b")).thenReturn(simpleTypeScenario2B);
		
		simpleTypeInferencerScenario2C = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario2C.getSimpleType("_c")).thenReturn(simpleTypeScenario2C);
		
		simpleTypeInferencerScenario2D = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario2D.getSimpleType("_d")).thenReturn(simpleTypeScenario2D);
		
		simpleTypeInferencerScenario2E = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario2E.getSimpleType("_e")).thenReturn(simpleTypeScenario2E);
		
		simpleTypeInferencerScenario2Attr = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario2Attr.getSimpleType("_raiz-_attr-SimpleTypeOfAttribute")).thenReturn(simpleTypeScenario2Attr);
	}
	
	/**
	 * Method that builds the {@link SchemaAttribute} objects and the attribute lists 
	 * used at scenario 2
	 */
	private void buildSchemaAttributesAndAttributeListsScenario2(){
		schemaAttributeScenario2Attr = new SchemaAttribute("attr", "", false, simpleTypeScenario2Attr);
		
		attributeListScenario2Raiz = Lists.newArrayList(schemaAttributeScenario2Attr);
	}
	
	/**
	 * Method that builds the attribute list inferencers used at scenario 2.
	 */
	private void buildAttributeListInferencersScenario2(){
		attributeListInferencerScenario2Raiz = mock(AttributeListInferencer.class);
		when(attributeListInferencerScenario2Raiz.getAttributesList()).thenReturn(attributeListScenario2Raiz);
	}
	
	/**
	 * Method that builds the {@link BasicStatisticsEntry} objects related to attributes of the second scenario.
	 */
	private void buildAttributeBasicStatisticsEntriesScenario2(){
		basicStatisticsEntryScenario2Attr = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
		
		basicStatisticsEntryScenario2AttrValueValue = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
	}
	
	/**
	 * Method that builds the mock {@link InferencersFactory} used at scenario 2, which returns 
	 * the corresponding {@link SimpleTypeInferencer} and {@link AttributeListInferencer} mocks.
	 */
	private void buildInferencersFactoryScenario2(){
		mockInferencersFactoryScenario2 = mock(InferencersFactory.class);
		
		//SimpleTypeInferencers
		when(mockInferencersFactoryScenario2.getSimpleTypeInferencerInstance(eq("_root"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario2Root);
		
		when(mockInferencersFactoryScenario2.getSimpleTypeInferencerInstance(eq("_raiz"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario2Raiz);
		
		when(mockInferencersFactoryScenario2.getSimpleTypeInferencerInstance(eq("_a"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario2A);
		
		when(mockInferencersFactoryScenario2.getSimpleTypeInferencerInstance(eq("_b"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario2B);
		
		when(mockInferencersFactoryScenario2.getSimpleTypeInferencerInstance(eq("_c"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario2C);
		
		when(mockInferencersFactoryScenario2.getSimpleTypeInferencerInstance(eq("_d"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario2D);
		
		when(mockInferencersFactoryScenario2.getSimpleTypeInferencerInstance(eq("_e"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario2E);
		
		when(mockInferencersFactoryScenario2.getSimpleTypeInferencerInstance(eq("_raiz-@_attr"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario2Attr);
		
		
		//AttributeListInferencers
		when(mockInferencersFactoryScenario2.getAttributeListInferencerInstance((Matchers.eq("_raiz")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerScenario2Raiz);
		
		when(mockInferencersFactoryScenario2.getAttributeListInferencerInstance((Matchers.eq("_root")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
		
		when(mockInferencersFactoryScenario2.getAttributeListInferencerInstance((Matchers.eq("_a")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
			
		when(mockInferencersFactoryScenario2.getAttributeListInferencerInstance((Matchers.eq("_b")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
		
		when(mockInferencersFactoryScenario2.getAttributeListInferencerInstance((Matchers.eq("_c")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
		
		when(mockInferencersFactoryScenario2.getAttributeListInferencerInstance((Matchers.eq("_d")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
		
		when(mockInferencersFactoryScenario2.getAttributeListInferencerInstance((Matchers.eq("_e")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerEmpty);
	...
	/**
	 * Method that builds almost everything of the scenario 2 
	 * (except for the configuration and some other details)
	 */
	private void buildAllMocksAndObjectsForScenario2(){
		buildSimpleTypesScenario2();
		buildSimpleTypeInferencersScenario2();
		buildSchemaAttributesAndAttributeListsScenario2();
		buildAttributeListInferencersScenario2();
		buildAttributeBasicStatisticsEntriesScenario2();
		buildInferencersFactoryScenario2();
	}
	
	/**
	 * Method that adds {@link BasicStatisticsEntry} objects related to attributes
	 * of the scenario 2, which have not been added previously by the {@link AttributeListInferencer} 
	 * mock, but are expected by {@link TypesExtractor} implementations.
	 * @param schema the current {@link Schema}
	 */
	private void appendMissingBasicStatisticsEntriesOfAttributesScenario2(Schema schema){
		Statistics statistics = schema.getStatistics();
		Map<String, BasicStatisticsEntry> attributeAtPathInfo = statistics.getAttributeAtPathInfo();
		Table<String, String, BasicStatisticsEntry> valuesAtPathInfo = statistics.getValuesAtPathInfo();
		Map<ComplexType, ComplexTypeStatisticsEntry> complexTypeInfo = statistics.getComplexTypeInfo();
		ComplexType complexTypeRaiz = schema.getComplexTypes().get("_raiz");
		ComplexTypeStatisticsEntry complexTypeRaizStatisticsEntry = complexTypeInfo.get(complexTypeRaiz);
		SchemaAttribute attr = schema.getAttributes().get("", "_raiz-attr");
		
		
		attributeAtPathInfo.put("/raiz/@attr", basicStatisticsEntryScenario2Attr);
		complexTypeRaizStatisticsEntry.getAttributeOccurrencesInfo().put(attr, basicStatisticsEntryScenario2Attr);
		valuesAtPathInfo.put("/raiz/@attr", "value", basicStatisticsEntryScenario2AttrValueValue);
		complexTypeRaizStatisticsEntry.getValuesInfo().put("value", attr, basicStatisticsEntryScenario2AttrValueValue);
	}
	
	//Third scenario mocks preparing
	
	/**
	 * It builds the SimpleType objects of the third scenario, which should be returned by the SimpleTypeInferencer mocks
	 */
	private void buildSimpleTypesScenario3(){
		simpleTypeScenario3NodoRaiz = new SimpleType("_nodoRaiz","",ImmutableSet.<String>of(),false);
		simpleTypeScenario3Attr = new SimpleType("_nodoRaiz-@_attr","xs:string",ImmutableSet.of("value"),false);
	}
	
	/**
	 * Method that builds the simple type inferencers used on scenario 2
	 */
	private void buildSimpleTypeInferencersScenario3(){
				
		simpleTypeInferencerScenario3NodoRaiz = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario3NodoRaiz.getSimpleType("_nodoRaiz")).thenReturn(simpleTypeScenario3NodoRaiz);
		
		simpleTypeInferencerScenario3Attr = mock(SimpleTypeInferencer.class);
		when(simpleTypeInferencerScenario3Attr.getSimpleType("_nodoRaiz-_attr-SimpleTypeOfAttribute")).thenReturn(simpleTypeScenario3Attr);
	}
	
	/**
	 * Method that builds the {@link SchemaAttribute} objects and the attribute lists on the third scenario
	 */
	private void buildSchemaAttributesAndAttributeListsScenario3(){
		schemaAttributeScenario3Attr = new SchemaAttribute("attr", "", true, simpleTypeScenario3Attr);
		
		attributeListScenario3NodoRaiz = Lists.newArrayList(schemaAttributeScenario3Attr);
	}
	
	/**
	 * Method that builds the attribute list inferencers of the third scenario.
	 */
	private void buildAttributeListInferencersScenario3(){
	
		attributeListInferencerScenario3NodoRaiz = mock(AttributeListInferencer.class);
		when(attributeListInferencerScenario3NodoRaiz.getAttributesList()).thenReturn(attributeListScenario3NodoRaiz);
	}
	
	/**
	 * Method that builds the {@link BasicStatisticsEntry} objects related to attributes of the third scenario.
	 */
	private void buildAttributeBasicStatisticsEntriesScenario3(){
		basicStatisticsEntryScenario3Attr = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
		
		basicStatisticsEntryScenario3AttrValueValue = new BasicStatisticsEntry(OCCURRENCES_LIST_ONCE_AT_SECOND_DOC);
	}
	
	/**
	 * Method that builds the {@link InferencersFactory} mock for the third scenario, which 
	 * returns the corresponding {@link SimpleTypeInferencer} and {@link AttributeListInferencer} 
	 * mocks.
	 */
	private void buildInferencersFactoryScenario3(){
		mockInferencersFactoryScenario3 = mock(InferencersFactory.class);
		
		//SimpleTypeInferencers
				
		when(mockInferencersFactoryScenario3.getSimpleTypeInferencerInstance(eq("_nodoRaiz"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario3NodoRaiz);
		
		when(mockInferencersFactoryScenario3.getSimpleTypeInferencerInstance(eq("_nodoRaiz-@_attr"), Matchers.<XSDInferenceConfiguration>any()))
		.thenReturn(simpleTypeInferencerScenario3Attr);
		
		
		//AttributeListInferencers
		when(mockInferencersFactoryScenario3.getAttributeListInferencerInstance((Matchers.eq("_nodoRaiz")), 
				Matchers.<XSDInferenceConfiguration>any(), Matchers.<Map<String,String>>any(),  Matchers.<Statistics>any()))
				.thenReturn(attributeListInferencerScenario3NodoRaiz);
	}
	
	/**
	 * Method that builds almost everything of the scenario 3 
	 * (except for the configuration and some other details)
	 */
	private void buildAllMocksAndObjectsForScenario3(){
		buildSimpleTypesScenario3();
		buildSimpleTypeInferencersScenario3();
		buildSchemaAttributesAndAttributeListsScenario3();
		buildAttributeListInferencersScenario3();
		buildAttributeBasicStatisticsEntriesScenario3();
		buildInferencersFactoryScenario3();
	}
	
	/**
	 * Method that adds {@link BasicStatisticsEntry} objects related to attributes
	 * of the scenario 3, which have not been added previously by the {@link AttributeListInferencer} 
	 * mock, but are expected by {@link TypesExtractor} implementations.
	 * @param schema the current {@link Schema}
	 */
	private void appendMissingBasicStatisticsEntriesOfAttributesScenario3(Schema schema){
		Statistics statistics = schema.getStatistics();
		Map<String, BasicStatisticsEntry> attributeAtPathInfo = statistics.getAttributeAtPathInfo();
		Table<String, String, BasicStatisticsEntry> valuesAtPathInfo = statistics.getValuesAtPathInfo();
		Map<ComplexType, ComplexTypeStatisticsEntry> complexTypeInfo = statistics.getComplexTypeInfo();
		ComplexType complexTypeRaiz = schema.getComplexTypes().get("_nodoRaiz");
		ComplexTypeStatisticsEntry complexTypeRaizStatisticsEntry = complexTypeInfo.get(complexTypeRaiz);
		SchemaAttribute attr = schema.getAttributes().get("", "_nodoRaiz-attr");
		
		
		attributeAtPathInfo.put("/nodoRaiz/@attr", basicStatisticsEntryScenario3Attr);
		complexTypeRaizStatisticsEntry.getAttributeOccurrencesInfo().put(attr, basicStatisticsEntryScenario3Attr);
		valuesAtPathInfo.put("/nodoRaiz/@attr", "value", basicStatisticsEntryScenario3AttrValueValue);
		complexTypeRaizStatisticsEntry.getValuesInfo().put("value", attr, basicStatisticsEntryScenario3AttrValueValue);
	}
	...
	public void setUp() throws Exception {
		...
		buildAllMocksAndObjectsForScenario1();
		
		typesExtractor1=new TypesExtractorImpl(testingXMLDocuments1, config1, mockInferencersFactoryScenario1);
		...
		buildAllMocksAndObjectsForScenario2();
		
		typesExtractor2=new TypesExtractorImpl(testingXMLDocuments2, config2y3, mockInferencersFactoryScenario2);
		...
		buildAllMocksAndObjectsForScenario3();
		
		typesExtractor3=new TypesExtractorImpl(testingXMLDocuments3, config2y3, mockInferencersFactoryScenario3);
	...
	public void testOnScenario1SchemaElements(){
		...
		appendMissingBasicStatisticsEntriesOfAttributesScenario1(schema);
	...
	public void testOnScenario1ComplexTypeRootElement3() {
		...
		assertTrue(complexTypeRootElement3.getTextSimpleType().isEmpty());
	...
	/**
	 * This test checks that the complex type _root-test_element3 is correctly generated on the first scenario.
	 */
	@Test
	...
	public void testOnScenario1ComplexTypeRootElement3StatisticsEntry(){
		...
		assertEquals(3,valuesInfo.size()); //Because of the empty value of element3
	...
	public void testOnScenario2SchemaElements(){
		...
		appendMissingBasicStatisticsEntriesOfAttributesScenario2(schema);
...
//		SchemaElement elementE = schema.getElements().get("", "_d-e");
	...
	public void testOnScenario3SchemaElements(){
		...
		appendMissingBasicStatisticsEntriesOfAttributesScenario3(schema);
